...
export const Route = createFileRoute("/examples/floating-anchor")({
...
function AnchoredToast() {
  ...
  return (
    <article
      className="pointer-events-auto relative flex min-w-[18rem] gap-4 rounded-[1.5rem] border border-[var(--line)] bg-[var(--surface-strong)] p-4 pr-12 shadow-[0_24px_50px_rgba(15,23,42,0.18)]"
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ref={bellRef}
          type="button"
          className="relative rounded-full border border-[var(--line)] bg-[var(--chip-bg)] px-4 py-2 font-semibold text-[var(--ink)]"
        >
          Bell
          {count > 0 ? (
