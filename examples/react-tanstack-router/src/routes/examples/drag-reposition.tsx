...
export const Route = createFileRoute("/examples/drag-reposition")({
  ...
  return (
    <>
      ...
      <motion.article
        ...
        className="pointer-events-auto fixed left-0 top-0 z-[9999] flex cursor-grab gap-4 rounded-[1.5rem] border border-[var(--line)] bg-[var(--surface-strong)] p-4 pr-12 shadow-[0_24px_50px_rgba(15,23,42,0.18)] select-none touch-none"
