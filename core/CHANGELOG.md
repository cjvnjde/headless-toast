...
- Add default tick scheduler for TimerManager and ambient global declarations
...
- Improve type tests for toast management and drag state handling
...
- Move mergeObjects utility function to a separate file
- Update packageManager version to pnpm@10.31.0
- Add repository URL to package.json
- Bump version to 0.0.1-alpha.2 in package.json
